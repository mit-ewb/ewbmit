...
<div class="container">
    ...
    <h1 class="mt-4 mb-3">Get Involved
        <small></small>
    </h1>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Involvement</li>
    </ol>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <ul>
                <li>Join us! We meet on Saturdays 6-7pm in room 5-134. Check out our calendar for meeting times, social events, cool conferences, and more! </li>
