...
<html lang="en">
  ...
  <?php include('navigationBar.php'); ?>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Our Projects
        <small>Take a look at what we do!</small>
      </h1>
      ...
      <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="#">
                    <img class="img-fluid rounded mb-3 mb-md-0" src="images/localprojects.jpg" alt="">
                </a>
            </div>
            <div class="col-md-5">
      ...
      <div class="row">
        <div class="col-md-7">
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="images/projects/moringa2.jpg" alt="">
          </a>
        </div>
        <div class="col-md-5">
      ...
      <div class="row">
        <div class="col-md-7">
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="images/projects/plastics.jpg" alt="">
          </a>
        </div>
        <div class="col-md-5">
